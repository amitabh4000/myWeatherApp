...
public class FetchWeatherTask extends AsyncTask<String, Void, Void> {
    ...
    public FetchWeatherTask(Context context) {
        Log.v(LOG_TAG,"inside asynctask");
        mContext = context;
    }
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if(locationCursor.moveToFirst()){
            ...
            Log.d(LOG_TAG,"Location already present "+ locationID);
        }
        else{
           ...
           locationvalues.put(WeatherContract.LocationEntry.COLUMN_COORD_LAT,lat);
            ...
            Log.d(LOG_TAG,"Location being added " + locationID);
        }
    ...
    protected Void doInBackground(String... params) {
        ...
        try {
            ...
            final String QUERY_APIKEY = "APPID";
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(QUERY_APIKEY, APPID)
            ...
            Log.v(LOG_TAG,"Json string: "+forecastJsonStr+ params[0]);
            Log.v(LOG_TAG,"City is: "+ params[0]);
