...
///////---------GET WEATHER BY LOCATION SETTING METHOD-------------//////////
...
//////----------GET WEATHER BY LOCATION SETTING AND DATE METHOD------------------///////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        Log.d("In weather provider","notify change");
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        // Student: A null value for selection deletes all rows.  In my implementation of this, I only notified
        ...
        switch (match) {
            case WEATHER: {
                //long _id = db.insert(WeatherContract.WeatherEntry.TABLE_NAME, null, values);
                rows_num=db.delete(WeatherContract.WeatherEntry.TABLE_NAME,selection,selectionArgs);
                break;
            }
            case LOCATION: {
                rows_num=db.delete(WeatherContract.LocationEntry.TABLE_NAME,selection,selectionArgs);
                break;
            }
            case WEATHER_WITH_LOCATION: {
                rows_num=db.delete(WeatherContract.WeatherEntry.TABLE_NAME,selection,selectionArgs);
    ...
    public int update(
        ...
        switch (match) {
            case WEATHER: {
                //long _id = db.insert(WeatherContract.WeatherEntry.TABLE_NAME, null, values);
                rows_num=db.update(WeatherContract.WeatherEntry.TABLE_NAME,values,selection,selectionArgs);
                break;
            }
            case LOCATION: {
                rows_num=db.update(WeatherContract.LocationEntry.TABLE_NAME,values,selection,selectionArgs);
                break;
            }
            case WEATHER_WITH_LOCATION: {
                rows_num=db.update(WeatherContract.WeatherEntry.TABLE_NAME,values,selection,selectionArgs);
